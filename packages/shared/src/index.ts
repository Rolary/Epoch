...
export const uiAssetPaths = [
  "bg-tidepool-board.png",
  "bg-home-tidepool.png",
  "card-crystal.png",
  "card-energy.png",
  "card-tide.png",
  ...
  "evolution/primitive-vesicle.png",
  "evolution/proto-cell.png",
  "evolution/replicating-chain.png",
  "pickup-crystal.png",
  "pickup-droplet.png",
  "pickup-pulse.png",
  "pickup-spark.png",
  "pool-centerpiece.png",
  "resource-biomass.png",
  "resource-energy.png",
  "resource-minerals.png",
  ...
  "species/species-filterer.png",
  "species/species-producer.png",
  "species/species-symbiont.png",
] as const;
